...
var Tree = /*#__PURE__*/function (_React$Component) {
  ...
  function Tree() {
    ...
    _defineProperty(_assertThisInitialized(_this), "domTreeNodes", {});
    ...
    _defineProperty(_assertThisInitialized(_this), "onNodeDragEnter", function (event, node) {
      ...
      if (!_this.dragNode || (0, _util.getDragNodesKeys)(children, node).indexOf(eventKey) !== -1) return;
    ...
    _defineProperty(_assertThisInitialized(_this), "onNodeDragOver", function (event, node) {
      ...
      var _node$props3 = node.props,
          ...
          children = _node$props3.children;
      _this.dragNode = node;
      ...
      if (dragNodesKeys.indexOf(eventKey) !== -1 && (0, _util.getDragNodesKeys)(children, node).indexOf(eventKey) !== -1) {
        return;
    ...
    _defineProperty(_assertThisInitialized(_this), "onNodeDrop", function (event, node) {
      ...
      var _node$props4 = node.props,
          eventKey = _node$props4.eventKey,
          pos = _node$props4.pos;
    ...
    _defineProperty(_assertThisInitialized(_this), "registerTreeNode", function (key, node) {
      if (node) {
